                        ...
                        <form method="POST" action="{{ route('stocks.add') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 mb-1">
                                    ...
                                    <div class="input-group">
                                        <input readonly id="quantity" type="number" step="any" placeholder="00"
                                            class="form-control @error('quantity') is-invalid @enderror" name="quantity"
                                            value="0" required autocomplete="quantity" autofocus
                                            style="float: left;">
                                ...
                                <div class="col-lg-4 mb-1">
                                    ...
                                    <div class="">
                                        <input id="special_price" type="number" step="any" placeholder="Tsh"
                                            ...
                                            name="special_price" value="0"required autocomplete="price" autofocus>
                                        @error('special_price')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                    ...
                    <tr>
                        ...
                        @if (Auth::user()->role_id == 1)
                            <td class="text-center">
                                <form id="toggle-status-form-{{ $stock->product->id }}" method="POST" class="px-2"
                                    action="{{ route('products.toggle-discount', $stock->product) }}">
                        ...
                        <td class="text-center">
                            ...
                            @if (Auth::user()->role_id == 1)
                                <a href="#" class="btn btn-sm btn-outline-primary collapsed mx-2" type="button"
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('stocks.edit', $stock) }}">
                                                ...
                                                <div class="text-start mb-1">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="name" type="text" placeholder=""
                                                            ...
                                                            required autocomplete="name" autofocus style="float: left;">
                                                        <select class="form-control form-select" name="type" required
                                                            style="float: left;max-width:115px; width: inaitial; background-color:rgb(238, 238, 242)">
                                                            <option value="Water"
                                                ...
                                                <div class="text-start mb-1">
                                                    ...
                                                    <div class="input-group">
                                                        <input id="volume" type="number" step="any"
                                                            ...
                                                            name="volume" value="{{ old('volume', $stock->volume) }}"
                                                            required autocomplete="volume" autofocus style="float: left;">
                                                        <select class="form-control form-select" name="measure" required
                                                            style="float: left;max-width:115px; width: inaitial; background-color:rgb(238, 238, 242)">
                                                            <option value="Litres"
                                                ...
                                                <div class="text-start mb-1">
                                                    ...
                                                    <div class="input-group">
                                                        <input readonly id="quantity" type="number" step="any"
                                                            placeholder="00"
